<script>
	$(document).ready(function() {
		...
		$(".simpan").click(function(){
			window.location="<?php echo site_url('level/formlevel');?>";
			return false;
		});
		$(".ubah").click(function(){
			var id= $(".bg-gray").attr("href");
			window.location="<?php echo site_url('level/formlevel');?>/"+id;
			return false;
		});
		...
		$(".ya").click(function(){
			var id=$(".bg-gray").attr("href");
			window.location="<?php echo site_url('level/hapuslevel');?>/"+id;
		});
...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			<?php echo form_open('level',array("id"=>"formsubmit"));?>
					...
					<tbody>
						<?php
		                    ...
		                    foreach ($row->result() as $row){
		                        $i++;
		                        echo "<tr id='data' href='".$row->id_level."'>
