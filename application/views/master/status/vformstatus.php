...
<div class="row">
	<div class="col-xs-12">
		<div class="box box-success">
			...
			<?php echo form_open('status/simpanstatus/'.$action,array("id"=>"formsubmit"));?>
			...
			<div class="box-body">
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" required name="nama_status" value="<?php echo $nama_status; ?>" />
						</div>
					</div>
				</div>
			</div>
