<script>
	$(document).ready(function() {
		...
		$(".simpan").click(function(){
			window.location="<?php echo site_url('rw/formrw');?>";
			return false;
		});
		$(".ubah").click(function(){
			var id= $(".bg-gray").attr("href");
			window.location="<?php echo site_url('rw/formrw');?>/"+id;
			return false;
		});
		...
		$(".ya").click(function(){
			var id=$(".bg-gray").attr("href");
			window.location="<?php echo site_url('rw/hapusrw');?>/"+id;
		});
		$(".reset").click(function(){
			window.location="<?php echo site_url('rw');?>";
		});
	});
</script>
<?php
...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			<?php echo form_open('rw',array("id"=>"formsubmit"));?>
					...
					<tbody>
						<?php
		                    ...
		                    foreach ($row->result() as $row){
		                        $i++;
		                        echo "<tr id='data' href='".$row->id_rw."'>
